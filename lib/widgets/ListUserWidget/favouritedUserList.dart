...
class FavouritedUserList extends StatefulWidget {
  const FavouritedUserList({super.key});

  @override
  State<FavouritedUserList> createState() => _FavouritedUserListState();
}

class _FavouritedUserListState extends State<FavouritedUserList> {
